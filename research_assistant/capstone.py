...
st.markdown("Search for academic papers, analyze or visualize your own research paper, or generate a professional summary.")
...
# -----------------------------------
# Step 4: Paper Search and Ranking
# -----------------------------------
...
# -----------------------------------
# Step 5: Paper Analysis Functions
# -----------------------------------
...
# -----------------------------------
# Step 6: Graphical Analysis Functions
# -----------------------------------
...
# -----------------------------------
# Step 7: Summary Generation Functions
# -----------------------------------
...
def main():
    ...
    with st.sidebar:
        st.header("Settings")
        top_k = st.slider("Number of search results", min_value=1, max_value=10, value=5)
        st.markdown("### About")
        st.markdown("This app searches academic papers, analyzes, visualizes, and summarizes uploaded research papers. Powered by Google Gemini.")
        st.markdown("### Made By")
        st.markdown("A.Ashfaq Ahamed (Biomedical Engineer)")
    ...
    with analyze_tab:
        ...
        # Section Analysis and Rewriting Section
